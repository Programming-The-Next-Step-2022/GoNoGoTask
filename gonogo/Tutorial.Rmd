...
p1_data <- gonogo(id = "my_name", # specify participant's name or id
                  ...
                  n_block = 4, # specify number of blocks
...
The play_gonogo() function returns a dataframe consisting of n_trial*n_block (number of trials times number of blocks) rows and six columns:
...
*SDT* = responses categorized according to Signal Detection Theory
